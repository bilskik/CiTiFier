...
import pl.bilskik.citifier.core.kubernetes.factory.deployment.K8sDeploymentFactory;
import pl.bilskik.citifier.core.kubernetes.factory.service.K8sNodePortFactory;

import java.util.Collections;
import java.util.Map;

import static pl.bilskik.citifier.core.kubernetes.data.K8sConstants.*;
import static pl.bilskik.citifier.core.kubernetes.util.K8sDeployerUtils.buildName;
import static pl.bilskik.citifier.core.kubernetes.util.K8sDeployerUtils.createEnvForSpecificDeployment;
