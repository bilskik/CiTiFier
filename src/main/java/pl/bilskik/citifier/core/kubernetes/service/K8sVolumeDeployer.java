...
import pl.bilskik.citifier.core.kubernetes.factory.statefulset.volume.K8sVolumeFactory;
import pl.bilskik.citifier.core.kubernetes.factory.statefulset.volume.K8sVolumeMountFactory;
...
public class K8sVolumeDeployer {
    ...
    public List<Volume> createVolumes(K8sResourceContext context, List<pl.bilskik.citifier.core.docker.entity.Volume> dockerVolumes) {
    ...
    public List<VolumeMount> createVolumeMounts(List<pl.bilskik.citifier.core.docker.entity.Volume> dockerVolumes) {
        return dockerVolumes.stream()
